...
Original file is located at
    https://colab.research.google.com/drive/1M6TekN786_MroPbJal-2ppz96nrKQIi6
"""
...
# Створення поліноміального регресора ступеня 10 та навчання його на тре-нувальних даних
...
plt.plot(X_test[:, 0], poly_linear_model.predict(polynomial.transform(X_test)), color='green', linewidth=2, label='Polynomial Regression')
